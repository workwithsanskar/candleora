...
function OrderDetail() {
  ...
  return (
    <section className="container-shell space-y-8 py-10">
      <div className="editorial-card bg-paper-glow p-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="rounded-[24px] bg-white/80 px-6 py-5 text-right">
                ...
                <div key={status} className="space-y-3">
                  ...
                  <p
                    className={`text-xs font-semibold uppercase tracking-[0.22em] ${
                      completed ? "text-brand-dark" : "text-brand-muted"
                    }`}
                  >
                    {titleCase(status)}
                  </p>
      ...
      <div className="grid gap-8 xl:grid-cols-[1.2fr_0.8fr]">
        <div className="panel space-y-4 p-6 sm:p-8">
          ...
          {order.items.map((item) => (
            <div
              key={item.id}
              className="flex items-center justify-between rounded-[20px] bg-brand-secondary p-4"
            >
              <div>
