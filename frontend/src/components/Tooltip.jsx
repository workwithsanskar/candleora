...
function Tooltip({ content, children, position = "top", className = "" }) {
  ...
  return (
    ...
    >
      ...
      <span
        role="tooltip"
        className={`pointer-events-none absolute left-1/2 z-[70] hidden min-h-[40px] -translate-x-1/2 items-center justify-center whitespace-nowrap rounded-[14px] border border-[#f3b33d]/55 bg-[#161616] px-4 py-2 text-[12px] font-medium leading-none text-white shadow-[0_16px_34px_rgba(0,0,0,0.24)] transition duration-150 md:inline-flex ${
          isBottom
            ? "top-full mt-3"
            : "bottom-full mb-3"
        } ${
