...
function PhoneAuthPanel({
  ...
  if (!isFirebaseConfigured()) {
    return (
      <div className="rounded-[24px] border border-dashed border-brand-primary/20 bg-white p-5">
  ...
  return (
    <div
      className={
        compact
          ? "rounded-[20px] border border-black/10 bg-white p-4"
          : "rounded-[26px] border border-black/10 bg-white p-5"
      }
    >
      ...
      <div className={`${compact ? "mt-4 gap-3" : "mt-5 gap-4"} grid sm:grid-cols-[1fr_auto]`}>
        ...
        <button
          ...
          className={`btn btn-outline disabled:opacity-60 sm:w-fit ${
            compact ? "px-4 py-2 text-[12px]" : ""
          }`}
        >
        ...
        <button
          ...
          disabled={disabled || isSending || isVerifying || !isSecureContextReady}
          className={`btn btn-secondary disabled:opacity-60 sm:self-end ${
            compact ? "px-4 py-2 text-[12px]" : ""
          }`}
        >
