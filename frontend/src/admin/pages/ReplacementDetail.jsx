  ...
  return (
    <>
      <div className="space-y-6">
        <FiltersBar
          title={replacement ? `Review request #${replacement.id}` : "Replacement details"}
          description="Review uploaded proof, capture your notes, and decide whether the request should be approved or rejected."
          actions={
            <button
              type="button"
            ...
            <section className="grid gap-4 xl:grid-cols-[280px_minmax(0,1fr)]">
              <div className="space-y-4 rounded-[28px] border border-black/10 bg-white p-5 shadow-sm">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="text-xs uppercase tracking-[0.22em] text-brand-muted">Proof</p>
              ...
              <div className="space-y-4">
                <div className="rounded-[28px] border border-black/10 bg-white p-5 shadow-sm">
                  <p className="text-xs uppercase tracking-[0.22em] text-brand-muted">Request details</p>
                ...
                <div className="rounded-[28px] border border-black/10 bg-white p-5 shadow-sm">
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                      <p className="text-xs uppercase tracking-[0.22em] text-brand-muted">Review controls</p>
                      <p className="mt-2 text-sm leading-6 text-brand-muted">
                        Add your review summary here, then approve or reject the request.
                      </p>
                    </div>
                  </div>
